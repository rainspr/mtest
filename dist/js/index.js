...
var _jst = __webpack_require__(33);

var _jst2 = _interopRequireDefault(_jst);
...
riot.tag2('app', '<nav class="navbar navbar-default"> <div class="container-fluid"> <div class="navbar-header"> <button class="navbar-toggle collapsed" type="button" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button><a class="navbar-brand" href="#">Riot Sample</a> </div> <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1"> <ul class="nav navbar-nav"> <li each="{link in links}"><a href="{link}">{link}</a></li> </ul> </div> </div> </nav> <div class="container-fluid"> <div id="content"> <router> <route path=""> <top></top> </route> <route path="fruit"> <fruit></fruit> </route> <route path="search.."> <search></search> </route> <route path=".."> <other></other> </route> </router> </div> </div>', '', '', function (opts) {
    this.links = ['/', '#', '#fruit', '#search?keyword=hello'];
});
riot.tag2('top', '<jst></jst>', '', '', function (opts) {

    var obs = riot.observable();
});
riot.tag2('fruit', '<h1>fruit page</h1>', '', '', function (opts) {});

riot.tag2('search', '<h1>search page</h1> <p each="{value, key in query}">{key}: {value}</p>', '', '', function (opts) {
    var _this = this;

    this.on('route', function () {
        return _this.query = _tag2.default.query();
    });
});
riot.tag2('other', '<h1>404</h1>', '', '', function (opts) {});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_riot_route__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_riot__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_riot___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_riot__);



__WEBPACK_IMPORTED_MODULE_1_riot___default.a.tag2('router', '<yield></yield>', '', '', function(opts) {
    var this$1 = this;


    this.route = __WEBPACK_IMPORTED_MODULE_0_riot_route__["a" /* default */].create();
    ...
    this.on('mount', function () {
      ...
      window.setTimeout(function () { return __WEBPACK_IMPORTED_MODULE_0_riot_route__["a" /* default */].start(true); }, 0);
    });
...
__WEBPACK_IMPORTED_MODULE_1_riot___default.a.tag2('route', '<virtual if="{show}"><yield></yield></virtual>', '', '', function(opts) {
    var this$1 = this;
...
/* harmony default export */ __webpack_exports__["default"] = (__WEBPACK_IMPORTED_MODULE_0_riot_route__["a" /* default */]);
...
riot.tag2('jst', '<h4 class="{text-warning: iswarn, text-danger: isdanger}">現在時刻: {clock}</h4>', '', '', function (opts) {
  var self = this;
  self.iswarn = false;
  self.isdanger = false;
  ...
  _axios2.default.get(self.serverurl + "?" + self.loaddate / 1000).then(function (response) {
  ...
  function updatetime() {
    ...
    var nownum = self.nowdate.getHours() * 100 + self.nowdate.getMinutes();
    switch (true) {
