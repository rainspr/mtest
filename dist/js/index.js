...
riot.tag2('app', '<nav><a each="{link in links}" href="{link}">{link}</a></nav> <router> <route path=""> <top></top> </route> <route path="fruit"> <fruit></fruit> </route> <route path="search.."> <search></search> </route> <route path=".."> <other></other> </route> </router>', 'a { margin: 1rem; font-size: 2rem; }', '', function (opts) {
    this.links = ['/', '#', '#fruit', '#search?keyword=hello'];
});
riot.tag2('top', '<h1>top page</h1>', '', '', function (opts) {});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_riot_route__ = __webpack_require__(4);
